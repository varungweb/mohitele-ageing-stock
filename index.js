...
FinalStatus AS (
    SELECT 
        CleanSerialNo,
        MAX(CASE WHEN ReversePhaseNo = 1 THEN LifeCyclePhaseShort END) AS LastPhase,
...
GROUP BY n.CleanSerialNo, f.LastVchType, f.FirstVchType, s.HasSameDayPurchaseAndSale
